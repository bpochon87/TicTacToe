...
function placeXorO(squareNumber)
{
    ...
    // array to see if it comtains the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber)))
    {
        ...
        if (activePlayer === 'X')
        {
            // If activePlayer is equal to 'X', the x.png is planed in HTML.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2)
{
    ...
    let x1 = coordX1,
        ...
        x = x1,
        // This variable stroes temp y axis data we update in our animation loop.
        y = y1;
    ...
    animateLineDrawing();
    // This line waits 1 second then clears canvas, resets game, and re-establishes click ability.
